...
- [x] 3.5 Add validate-all mode when no name provided (scan `synergyspec/schemas/`)
...
- [x] 5.7 Add `--default` flag to update `synergyspec/config.yaml` with new schema as default
