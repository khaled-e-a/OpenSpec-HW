...
- **THEN** the command SHALL:
  ...
  - Replace `synergyspec/AGENTS.md` with the latest template (complete replacement)
...
- **AND** create or update the root-level `AGENTS.md` using the SynergySpec markers
- **AND** update only the SynergySpec-managed blocks in **existing** AI tool files using markers
