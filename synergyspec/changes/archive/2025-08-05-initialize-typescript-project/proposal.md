...
## Why
The SynergySpec project needs a proper TypeScript foundation to build the minimal CLI that helps developers set up SynergySpec file structures and keep AI instructions updated.
