...
This module will coexist with the current SynergySpec system as a parallel capability, potentially enabling future migration or integration.
...
- Replacing existing SynergySpec functionality
...
**Resolution order:**
1. `${XDG_DATA_HOME:-~/.local/share}/synergyspec/schemas/<name>.yaml` - Global user override
...
- Unix/macOS fallback: `~/.local/share/synergyspec/`
- Windows fallback: `%LOCALAPPDATA%/synergyspec/`
...
- Global user override: `${XDG_DATA_HOME:-~/.local/share}/synergyspec/schemas/<name>.yaml`
