...
- [x] Change FILE_PATHS in `src/core/configurators/slash/cline.ts` from `.clinerules/synergyspec-*.md` to `.clinerules/workflows/synergyspec-*.md`
...
- [x] Verify the change follows SynergySpec conventions
