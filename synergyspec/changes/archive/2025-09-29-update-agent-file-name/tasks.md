...
- [x] Rename `synergyspec/README.md` to `synergyspec/AGENTS.md`
...
- [x] Ensure CLAUDE.md markers link to `@synergyspec/AGENTS.md`

## 4. Update Specifications
- [x] Modify `cli-init` spec to reference `AGENTS.md`
- [x] Modify `cli-update` spec to reference `AGENTS.md`
- [x] Modify `synergyspec-conventions` spec to include `AGENTS.md` in project structure
