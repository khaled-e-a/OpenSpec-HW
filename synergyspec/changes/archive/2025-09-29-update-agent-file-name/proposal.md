...
## Problem
The agent instructions live in `synergyspec/README.md`, which clashes with conventional project README usage and creates confusion for tooling and contributors.

## Solution
Rename the agent instruction file to `synergyspec/AGENTS.md` and update SynergySpec tooling to use the new filename:
...
## Success Metrics
- `openspec init` creates `synergyspec/AGENTS.md`
- `openspec update` refreshes `AGENTS.md`
- All specs reference `synergyspec/AGENTS.md`
