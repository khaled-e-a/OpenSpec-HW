...
- [x] 1.6 Implement spec sync prompt (check for specs/ directory, offer `/synspec:sync`)
...
- [x] 3.1 Test `/synspec:archive` with a complete change (all artifacts, all tasks done)
- [x] 3.2 Test `/synspec:archive` with incomplete artifacts (verify warning shown)
- [x] 3.3 Test `/synspec:archive` with incomplete tasks (verify warning shown)
- [x] 3.4 Test `/synspec:archive` with delta specs (verify sync prompt shown)
- [x] 3.5 Test `/synspec:archive` without change name (verify selection prompt)
