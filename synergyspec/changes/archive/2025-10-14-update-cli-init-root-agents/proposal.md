...
- Ensure `openspec update` continues to reconcile both `synergyspec/AGENTS.md` and the root stub, documenting the expected behaviour so mismatched setups self-heal.
