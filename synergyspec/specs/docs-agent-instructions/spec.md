...
- **WHEN** `synergyspec/AGENTS.md` is regenerated or updated
...
`synergyspec/AGENTS.md` SHALL include complete copy/paste templates and inline examples exactly where agents make corresponding edits.
...
`synergyspec/AGENTS.md` SHALL offer a concise pre-validation checklist that highlights common formatting mistakes before running `openspec validate`.
...
- **WHEN** reorganizing `synergyspec/AGENTS.md`
...
- **WHEN** `synergyspec/AGENTS.md` explains how to write `spec.md`
