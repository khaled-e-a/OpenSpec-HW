...
export function getProjectSchemasDir(projectRoot: string): string {
  return path.join(projectRoot, 'synergyspec', 'schemas');
}
 ...
 * 1. Project-local: <projectRoot>/synergyspec/schemas/<name>/schema.yaml
 * 2. User override: ${XDG_DATA_HOME}/synergyspec/schemas/<name>/schema.yaml
