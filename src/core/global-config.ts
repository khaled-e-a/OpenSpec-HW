...
// Constants
export const GLOBAL_CONFIG_DIR_NAME = 'synergyspec';
export const GLOBAL_CONFIG_FILE_NAME = 'config.json';
export const GLOBAL_DATA_DIR_NAME = 'synergyspec';
 ...
 *
 * - All platforms: $XDG_CONFIG_HOME/synergyspec/ if XDG_CONFIG_HOME is set
 * - Unix/macOS fallback: ~/.config/synergyspec/
 * - Windows fallback: %APPDATA%/synergyspec/
 */
 ...
 *
 * - All platforms: $XDG_DATA_HOME/synergyspec/ if XDG_DATA_HOME is set
