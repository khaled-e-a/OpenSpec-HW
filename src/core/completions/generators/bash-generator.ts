...
/**
 * Generates Bash completion scripts for the SynergySpec CLI.
...
export class BashGenerator implements CompletionGenerator {
  ...
  generate(commands: CommandDefinition[]): string {
    ...
    return `# Bash completion script for SynergySpec CLI
# Auto-generated - do not edit manually

_synergyspec_hw_completion() {
...
${helpers}
complete -F _synergyspec_hw_completion synergyspec-hw
`;
  }
  ...
  private generatePositionalCompletion(positionalType: string | undefined, indent: string): string[] {
    ...
    switch (positionalType) {
      case 'change-id':
        lines.push(`${indent}_synergyspec_hw_complete_changes`);
        break;
      case 'spec-id':
        lines.push(`${indent}_synergyspec_hw_complete_specs`);
        break;
      case 'change-or-spec-id':
        lines.push(`${indent}_synergyspec_hw_complete_items`);
        break;
      case 'shell':
