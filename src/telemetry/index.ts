 ...
 * - Opt-out via SYNERGYSPEC_TELEMETRY=0 or DO_NOT_TRACK=1
 ...
 *
 * Disabled when:
 * - SYNERGYSPEC_TELEMETRY=0
 * - DO_NOT_TRACK=1
 * - CI=true (any CI environment)
 */
export function isTelemetryEnabled(): boolean {
  // Check explicit opt-out
  if (process.env.SYNERGYSPEC_TELEMETRY === '0') {
    return false;
  }
 ...
 * @param version - The SynergySpec version
 */
