 ...
 * Stores anonymous ID and notice-seen flag in ~/.config/synergyspec/config.json
 */
 ...
 * Uses ~/.config/synergyspec/config.json on all platforms.
 */
export function getConfigPath(): string {
  const configDir = path.join(os.homedir(), '.config', 'synergyspec');
