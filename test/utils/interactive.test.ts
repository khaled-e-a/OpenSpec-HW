...
describe('interactive utilities', () => {
  let originalSynergySpecInteractive: string | undefined;
  let originalCI: string | undefined;
  let originalStdinIsTTY: boolean | undefined;

  beforeEach(() => {
    // Save original environment
    originalSynergySpecInteractive = process.env.OPEN_SPEC_INTERACTIVE;
  ...
  afterEach(() => {
    ...
    if (originalSynergySpecInteractive !== undefined) {
      process.env.OPEN_SPEC_INTERACTIVE = originalSynergySpecInteractive;
    } else {
      delete process.env.OPEN_SPEC_INTERACTIVE;
    }
