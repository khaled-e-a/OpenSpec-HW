...
This spec implements requirements for the widget-drag-drop capability — the drag-and-drop interaction layer enabling users to rearrange widgets on a dashboard grid with snapping behaviour.
