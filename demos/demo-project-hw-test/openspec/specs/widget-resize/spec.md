...
Defines the resize interaction model for dashboard widgets, covering resize handles, live preview, minimum and maximum size constraints, neighbour collision during resize, and commit/cancel behaviour.
