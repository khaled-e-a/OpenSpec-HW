...
Defines the behaviour of the dashboard grid container: column configuration, absolute widget positioning, collision prevention, serializable layout state, and add/remove widget operations.
