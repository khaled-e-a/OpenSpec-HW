...
Defines the drag-and-drop interaction model for dashboard widgets, covering drag initiation, ghost preview, live snap indicators, drop commit behaviour, keyboard cancellation, and touch device support.
