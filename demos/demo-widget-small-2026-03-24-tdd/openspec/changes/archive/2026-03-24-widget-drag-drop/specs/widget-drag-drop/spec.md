...
## Overview
This spec implements requirements for the `widget-drag-drop` capability — a React grid dashboard where variable-sized widgets can be dragged, snapped to grid cells, and repositioned without overlap.
