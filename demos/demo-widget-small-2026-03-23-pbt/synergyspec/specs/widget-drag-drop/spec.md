...
| UC6-S3 | System validates the settings map against currently registered widget IDs | Widget registry defines available types |
| UC6-E3a1 | System silently discards settings entries for widget IDs no longer in the layout | Stale stub-type widgets pruned on load |
