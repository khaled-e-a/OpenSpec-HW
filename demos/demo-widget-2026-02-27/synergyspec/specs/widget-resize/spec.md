...
Defines the behaviour of widget resizing within the dashboard grid: how resize handles are presented and suppressed, how a resize interaction is initiated via pointer-down on the handle, how a ghost overlay visualises the new span during resize, how minimum and maximum span constraints are enforced, how a resize commit applies or rejects the new dimensions, and how Escape cancels an in-progress resize.
